...
<div class="form">
  ...
  <h2>Vendo Dados de <span><?php echo $cow['user_nome']; ?></span></h2>

  <form class="formulario" action="back_gerenciar_dados.php" method="post">
    <label>Nome: <span><?php echo $cow['user_nome']; ?></span></label>
    <label>Telefone: <span><?php echo $cow['user_tel']; ?></span></label>
    <label>Login: <span><?php echo $cow['user_login']; ?></span></label>
    <label>Senha: <span><?php echo $cow['user_senha']; ?></span></label>
    <label>Email: <span><?php echo $cow['user_email']; ?></span></label>
    <label>Cpf: <span><?php echo $cow['user_cpf']; ?></span></label>
